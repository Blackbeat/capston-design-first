...
public class ChatSubmitServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (roomID == null || roomID.equals("") || chatName == null || chatName.equals("") || chatContent == null || chatContent.equals("")) {
			response.getWriter().write("0");
		} else { 
			response.getWriter().write(new Dao().submit(roomID, chatName, chatContent));
		}  
