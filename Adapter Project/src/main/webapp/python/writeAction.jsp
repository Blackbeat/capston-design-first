...
<%
		...
		String directory = "C:/Users/lily5/OneDrive/Document/eclipse-workspace/Adapter Project/Adapter Project/src/main/webapp/upload/PythonBBS";
		...
		if(userID == null){
			...
			if(bbs.getBbsTitle() == null || bbs.getBbsContent() == null){
				...
				new PythonBBSFileDao().upload(fileName, fileRealName, bbs.getBbsID());
