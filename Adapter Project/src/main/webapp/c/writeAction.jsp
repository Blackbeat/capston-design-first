...
<%
		...
		String directory = "C:/Users/lily5/OneDrive/Document/eclipse-workspace/Adapter Project/Adapter Project/src/main/webapp/upload/CBBS";
		...
		if(userID == null){
			...
			if(bbs.getBbsTitle() == null || bbs.getBbsContent() == null){
				...
				new CBBSFileDao().upload(fileName, fileRealName, bbs.getBbsID());
